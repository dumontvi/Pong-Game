...
stwio r2, 8(r3)        #store into JP1
 ...
 movia  r4,JP1_IRQ  #enable interrupt for JP1(set bit 11)
 wrctl	ctl3,r4			

 movia 	r4,1             #enable global interrupts
 wrctl 	ctl0,r4			       
 ...
 cmpeqi	r6,r5,0x01e                #Sensor 1 check
 bne	r6,r0,VGA_left
	
 cmpeqi	r6,r5,0x01d               #Sensor 2 Check
 bne	r6,r0,VGA_right
